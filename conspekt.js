...
Так же npx сначало устанавливает модуль, если он не установлен, а затем он отрабатывает,
например: npx create-react-app my-app  сначало установит модуль create-react-app, который потом создаст проект my-app
